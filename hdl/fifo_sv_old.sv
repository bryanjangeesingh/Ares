...
//    typedef enum logic [1:0] {WAITING=0, FILLING=1, DUMPING=2} fifo_state;
    (* ASYNC_REG = "TRUE" *) logic [1:0] state;
...
//    (* ASYNC_REG = "TRUE" *) fifo_state state;
    ...
    (* ASYNC_REG = "TRUE" *) logic trigger_prev, trigger_prev_2;

    (* ASYNC_REG = "TRUE" *) logic [1:0] state_prev, state_prev_2;

    (* ASYNC_REG = "TRUE" *) logic done_dumping_prev,done_dumping_prev_2;
    ...
    always_ff @(posedge s00_axis_aclk) begin
        ...
        trigger_prev <= laser_trigger;
        trigger_prev_2 <= trigger_prev;
